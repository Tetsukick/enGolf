...
VersionEntity $VersionEntityFromJson(Map<String, dynamic> json) {
	...
	final String? latestVersion = jsonConvert.convert<String>(json['latest_version']);
	if (latestVersion != null) {
		versionEntity.latestVersion = latestVersion;
	}
	final String? minSupportVersion = jsonConvert.convert<String>(json['min_support_version']);
