...
dynamic getJsonField(
  ...
  if (field.length > 1) {
    return field.map<dynamic>((f) => f.value).toList();
  }
  final dynamic value = field.first.value;
  return isForList && value is! Iterable ? <dynamic>[value] : value;
}
...
void setAppLanguage(BuildContext context, String language) =>
    HomeScreen.of(context).setLocale(language);

void setDarkModeSetting(BuildContext context, ThemeMode themeMode) =>
    HomeScreen.of(context).setThemeMode(themeMode);
